...
function FacilityEditForm({ facility, onClose }: FacilityEditFormProps) {
  ...
  const submit = (e: React.FormEvent) => {
    ...
    const result = updateFacility(facility.id, {
      name,
      category,
      // Only allow setting active/damaged/disabled — under-construction is
      // managed by the build/turn engine, not the editor.
